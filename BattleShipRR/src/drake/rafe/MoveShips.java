...
public class MoveShips {
	...
	//Rotate 
	ship2.setOnMouseClicked(event -> {
	    ship2.setRotate(ship2.getRotate() + 90);
	});
	...
	ship3a.setOnMouseClicked(event -> {
	    ship3a.setRotate(ship3a.getRotate() + 90);
	});
	...
	ship3a.setOnMouseClicked(event -> {
	    ship3b.setRotate(ship3b.getRotate() + 90);
	...
	ship3c.setOnMouseClicked(event -> {
	    ship3c.setRotate(ship3c.getRotate() + 90);
	...
	ship4a.setOnMouseClicked(event -> {
	    ship4a.setRotate(ship4a.getRotate() + 90);
	...
	ship4b.setOnMouseClicked(event -> {
	    ship4b.setRotate(ship4b.getRotate() + 90);
